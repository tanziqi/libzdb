...
/**
 * Returns this Connection Pool @@autocommit value
 * @param P A ConnectionPool object
 * @return This Connection @@autocommit value
 * @see mysql_autocommit
 */
bool ConnectionPool_isAutoCommit(T P);

/**
 * Set Connection Pool enable autocommit. maybe only mysql. default disabled
 * @param C A ConnectionPool object
 */
void ConnectionPool_enableAutoCommit(T P);
