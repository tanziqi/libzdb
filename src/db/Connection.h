...
/**
 * If you want use result seek, you must set true
 * @param C A Connection object
 * @param bool isStoreResult
 */
void Connection_setStoreResult(T C, int isStoreResult);


/**
 * Get 'isStoreResult' value of this Connection.
 * @param C A Connection object
 * @return 'isStoreResult' value
 */
bool Connection_isStoreResult(T C);
...
/**
 * Returns this Connection @@autocommit value
 * @param C A Connection object
 * @return This Connection @@autocommit value
 * @see mysql_autocommit
 */
bool Connection_isAutoCommit(T C);
